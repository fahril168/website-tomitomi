      ...
      <div ref={footerRef} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center gap-2 pt-2">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-9 h-9 rounded-lg bg-slate-800/80 hover:bg-emerald-600 flex items-center justify-center text-slate-400 hover:text-white transition-all duration-200 hover:scale-110"
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          ...
          <div className="flex items-center gap-6">
            ...
            <button
              onClick={scrollToTop}
              className="flex items-center gap-1.5 text-emerald-400 hover:text-emerald-300 font-medium transition-colors animate-float"
            >
              <span>Ke Atas</span>
